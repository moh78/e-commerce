...
<head>
	...
	<title>Home</title>	
    <link rel="shortcut icon" type="image/x-icon" href="{{secure_asset('assets/images/favicon.ico')}}">
...
<body class="home-page home-01 ">
					...
					<div class="container">
						...
						<div class="topbar-menu right-menu">
									...
									@if(Auth::user()->utype === 'ADM')
										<li class="menu-item menu-item-has-children parent" >
											...
											<ul class="submenu curency" >
												...
												<li class="menu-item" >
													<a title="Admin panel" href="/admin/product">Admin panel</a>
												</li>
												<li class="menu-item">
									...
									@else
										<li class="menu-item menu-item-has-children parent" >
											...
											<ul class="submenu curency" >
												...
												<li class="menu-item" >
													<a title="Mon profil" href="{{ route('user.profile_edit') }}">My profil</a>
												</li>
												<li class="menu-item" >
							...
							@endif
								...
								<li class="menu-item menu-item-has-children parent" >
									<a title="Euro (EUR)" href="#">Euro (EUR)<i class="fa fa-angle-down" aria-hidden="true"></i></a>
									<ul class="submenu curency" >
										<li class="menu-item" >
	...
	<script src="{{ secure_asset('assets/js/momentjs.js') }}"></script>
	<script src="{{ secure_asset('assets/js/jquery.sticky.js') }}"></script>
