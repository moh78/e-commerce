...
class UserEditProfileComponent extends Component
{
    ...
    public function mount()
    {
        ...
        if(!$userProfile)
        {
            ...
            $this->mobile = 111111;
            $profile->line1="A definir dans mon profil";
            $profile->line2="A definir dans mon profil";
            $profile->city="A definir dans mon profil";
            $profile->province="A definir dans mon profil";
            $profile->country="A definir dans mon profil";
            $profile->save();
        }
    ...
    public function updateProfile()
    {
        ...
        //     if($this->image)
        //     {
        //         unlink('public/assets/images/profile/'.$this->image);
        //     }
